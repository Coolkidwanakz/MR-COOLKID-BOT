...
const config = {
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || '✅️ Status Viewed by COOLKID',
  ...
  OWNER_NAME: process.env.OWNER_NAME || "COOLKID-TECH",
  AUTO_BLOCK: process.env.AUTO_BLOCK || "212,99,90",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "2547701156250",
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "2547701156250,2547701156250",
